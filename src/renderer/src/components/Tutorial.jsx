...
export default function Tutorial() {
  ...
  return (
    <div className="flex flex-col items-center pt-10 h-screen text-white">
      ...
      <h1 className="lg:text-5xl text-4xl mb-4 pb-4 uppercase text-white">VideoBox</h1>
      ...
      <ul className="flex flex-col gap-6 pt-5 lg:text-2xl text-xl">
        <li>
          <p>
            Presione <span className="bg-white text-black px-2 py-1 rounded-md">F11</span> para
        ...
        <li>
          <p>
            ...
            <span className="bg-white text-black px-4 py-1 rounded-md">5</span> )
          </p>
        </li>
        <li>
          <p>
            ...
            <span className="bg-white text-black px-4 py-1 rounded-md">
              DD-MM-YYYY_HH-mm-ss.mp4
            </span>{' '}
            en el disco D:
          </p>
        </li>
      </ul>
      <p className="animate-pulse animate-infinite animate-duration-[3000ms] animate-ease-in text-2xl md:text-4xl lg:text-5xl font-bold mt-8 lg:mt-12">
